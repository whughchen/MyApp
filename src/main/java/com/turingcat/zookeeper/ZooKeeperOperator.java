 ...
 * Created：20 May 2016 10:04:26 
 */
package com.turingcat.zookeeper;
		...
		try{
			...
			if(list.isEmpty()){
				...
				for(String child:list){
					log.debug("节点为："+child);
					String aString=new String(getData(path+"/"+child));
					log.debug("节点内容为："+aString);
				}
			}
	...
	public byte[] getData(String path) throws KeeperException, InterruptedException {   
	 ...
	 public static void main(String[] args) {
		 try {   
	            ...
	            zkoperator.connect("172.16.35.16");
